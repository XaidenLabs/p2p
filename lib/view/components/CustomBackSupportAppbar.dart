...
const CustomBackSupportAppBar({Key? key,this.showTitle=true,this.showActionIconInStart=false,this.title='',this.backBtnIconColor=MyColor.colorBlack,this.backBtnBgColor=Colors.transparent, required this.press,this.isShowActionBtn=false,this.press2, }) : super(key: key);
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    const Spacer(),
                    Text(title.tr,style: mulishSemiBold.copyWith(fontSize:Dimensions.fontLarge,color: MyColor.colorBlack),),
                    const Spacer(),
                   const SizedBox(
                     height: 40,
                     width: 40,
