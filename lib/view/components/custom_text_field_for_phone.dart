    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        border:  OutlineInputBorder(
          borderRadius:widget.withSuffix?const BorderRadius.only(topLeft: Radius.circular(Dimensions.textFieldRadius),bottomLeft:Radius.circular(Dimensions.textFieldRadius)): const BorderRadius.only(topRight: Radius.circular(Dimensions.textFieldRadius),bottomRight:Radius.circular(Dimensions.textFieldRadius)),
        ...
        errorBorder:  OutlineInputBorder(
          borderRadius:widget.withSuffix?const BorderRadius.only(topLeft: Radius.circular(Dimensions.textFieldRadius),bottomLeft:Radius.circular(Dimensions.textFieldRadius)): const BorderRadius.only(topRight: Radius.circular(Dimensions.textFieldRadius),bottomRight:Radius.circular(Dimensions.textFieldRadius)),
          borderSide:  const BorderSide(color: MyColor.red, width: 0.5),
        ),
        focusedErrorBorder:  OutlineInputBorder(
          borderRadius:widget.withSuffix?const BorderRadius.only(topLeft: Radius.circular(Dimensions.textFieldRadius),bottomLeft:Radius.circular(Dimensions.textFieldRadius)): const BorderRadius.only(topRight: Radius.circular(8),bottomRight:Radius.circular(8)),
        ...
        suffixIcon: widget.isShowSuffixIcon
            ? widget.isPassword
            ? IconButton(
            icon: Icon(_obscureText ? Icons.visibility_off : Icons.visibility, color: MyColor.hintTextColor2),
            onPressed: _toggle)
            : widget.isIcon
            ? IconButton(
